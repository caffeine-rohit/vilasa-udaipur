...
export default function PalacePage() {
  ...
  return (
    <main className="bg-ivory min-h-screen text-ink">
      ...
      <section className="py-24 md:py-40 px-4 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 auto-rows-[300px]">
          ...
          <div className="md:col-span-5 md:row-span-2 relative group">
            <div className="w-full h-full relative overflow-hidden bg-dusk/10 border border-gold/20">
               <div className="absolute inset-0 bg-[url('/media/images/palace-page/Carved_Jaali.jpeg')] bg-cover bg-center transition-transform duration-1000 group-hover:scale-105"></div>
            </div>
          ...
          <div className="md:col-span-4 md:row-span-1 relative group mt-12">
            <div className="w-full h-full relative overflow-hidden jharokha-mask">
              <Image 
          ...
          <div className="md:col-span-7 md:row-span-1 relative group">
            <div className="w-full h-full relative overflow-hidden bg-dusk/5 border border-gold/20">
               <div className="absolute inset-0 bg-[url('/media/images/palace-page/Courtyard.jpeg')] bg-cover bg-center transition-transform duration-1000 group-hover:scale-105"></div>
            </div>
          ...
          <div className="md:col-span-4 md:col-start-9 md:row-start-2 md:row-span-2 relative group -mt-24">
            <div className="w-full h-full relative overflow-hidden jharokha-mask">
               <div className="absolute inset-0 bg-[url('/media/images/palace-page/Palace_corridor.jpeg')] bg-cover bg-center transition-transform duration-1000 group-hover:scale-105"></div>
            </div>
      ...
      {/* Closing Statement */}
      <section className="bg-ink py-32 px-4 text-center border-t border-gold relative">
